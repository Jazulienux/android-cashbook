            ...
            public void onClick(View v) {
                ...
                if(temp_date.length() == 0){
                    ...
                    if(nom <= 0){
                        ...
                        boolean cond = db.insertCash(id_user, temp_date, nom, ket_text, 0);
                        if(cond){
                            showMsg("Data Tambah Pengeluaran Berhasil Ditambahkan");
                            temp_date = "";
                            tgl.setText("");
                            nominal.setText("");
                            keterangan.setText("");
                            ...
                            showMsg("Data Tambah Pengeluaran Gagal Ditambahkan");
                        }
                    }
                }
            }
